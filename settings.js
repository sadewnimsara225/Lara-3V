...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "6BpVgIrD#4_KVaA2jizAEd7rCIl-GoS8Hvwti4B8sJxw4WV6TW58", // Add your session id
PREFIX: process.env.PREFIX || "SADEW",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94770681768",
DEV: process.env.DEV || "94770681768",
